...
{
#ifdef _RENESAS_SYNERGY_
    static int display_enter = 0;
    static int display_palette = 0;
    static int display_menu = 0;
    static int display_finish = 0;
#endif
    ...
    if (display_enter == 0)
    {
        doom_set_error_literal("stage: display enter");
        display_enter = 1;
    }
#endif
    ...
    {
#ifdef _RENESAS_SYNERGY_
        doom_set_error_literal("stage: render view");
#endif
    ...
    {
#ifdef _RENESAS_SYNERGY_
        if (display_palette == 0)
        {
            doom_set_error_literal("stage: display palette");
            display_palette = 1;
        }
#endif
    	I_SetPalette (W_CacheLumpName (DEH_String("PLAYPAL"),PU_CACHE));
#ifdef _RENESAS_SYNERGY_
        doom_set_error_literal("stage: display post-palette");
#endif
    }
    ...
    {
#ifdef _RENESAS_SYNERGY_
        doom_set_error_literal("stage: display border");
#endif
    ...
    if (display_menu == 0)
    {
        doom_set_error_literal("stage: display menu");
        display_menu = 1;
    }
#endif
    ...
    if (!wipe)
    {
        ...
        if (display_finish == 0)
        {
            doom_set_error_literal("stage: display finish");
            display_finish = 1;
        }
#endif
...
{
#ifdef _RENESAS_SYNERGY_
    static int tick_started = 0;
    static int tick_ran_tics = 0;
    static int tick_display = 0;
#endif
    ...
    if (tick_started == 0)
    {
        doom_set_error_literal("stage: tick start");
        tick_started = 1;
    }
#endif
    ...
    if (tick_ran_tics == 0)
    {
        doom_set_error_literal("stage: tick tics");
        tick_ran_tics = 1;
    }
#endif
    ...
    if (screenvisible)
    {
        ...
        if (tick_display == 0)
        {
            doom_set_error_literal("stage: tick display");
            tick_display = 1;
        }
#endif
        D_Display ();
...
{
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: loop enter");
#endif
...
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: loop tics");
#endif
    TryRunTics();

#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: loop graphics");
#endif
...
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: loop view");
#endif
    V_RestoreBuffer();
    R_ExecuteSetViewSize();

#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: loop start");
#endif
    D_StartGameLoop();
...
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: loop first tick");
#endif
    doomgeneric_Tick();
}
...
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: ST_Init");
#endif
    ST_Init ();
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: init done");
#endif
