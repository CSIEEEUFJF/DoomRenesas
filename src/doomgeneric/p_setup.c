...
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: setup lumps");
#endif
...
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: setup geom");
#endif
...
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: setup things");
#endif
...
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: setup specials");
#endif
...
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: setup done");
#endif
