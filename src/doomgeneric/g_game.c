...
#ifdef _RENESAS_SYNERGY_
boolean         precache = false;       // keep the embedded target under the RAM limit
#else
...
{ 
...
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: G_InitNew");
#endif
    ...
    #ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: P_SetupLevel");
    #endif
    P_SetupLevel (gameepisode, gamemap, 0, gameskill);    
    #ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: level ready");
    #endif
