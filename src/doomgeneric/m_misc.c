...
boolean M_FileExists(char *filename)
{
    ...
    if (M_StringEndsWith(filename, "doom1.wad") && doom1_wad_len > 0)
    {
        return true;
    }
...
int M_ReadFile(char *name, byte **buffer)
{
    ...
    if (M_StringEndsWith(name, "doom1.wad") && doom1_wad_len > 0)
    {
        I_Error("Embedded doom1.wad is memory-mapped and cannot be copied into RAM");
    }
