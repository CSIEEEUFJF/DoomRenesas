...
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: ST_initData");
#endif
...
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: ST_data");
#endif
...
void ST_Start (void)
{
...
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: ST_Start");
#endif
    ...
    ST_createWidgets();
#ifdef _RENESAS_SYNERGY_
    doom_set_error_literal("stage: ST_widgets");
#endif
    st_stopped = false;
